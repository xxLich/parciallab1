...
/// Se juega por quien empieza primero
    ...
    jugarPorTurnoLab(vJugadores,estatuillas);
...
///**************************************
    ...
    while(terminarExpedicion(estatuillas))
    {
        ...
        for(int i=0; i<vJugadores[0].rondas; i++)
        {
            ...
            if( evaluarMaldicionSalamandraLab(vJugadores,0))
            {

                evaluarSeleccionTresDadosLab(seleccion,0,vJugadores,estatuillas);
            }
            else
            {

                evaluarSeleccionDosDadosLab(seleccion,0,vJugadores,estatuillas);
            }
        ...
        for(int i=0; i<vJugadores[1].rondas; i++)
        {
            ...
            if( evaluarMaldicionSalamandraLab(vJugadores,1))
            {

                evaluarSeleccionTresDadosLab(seleccion,1,vJugadores,estatuillas);
            }
            else
            {

                evaluarSeleccionDosDadosLab(seleccion,1,vJugadores,estatuillas);
            }
...
///********************************
    ...
    while(FinFF==false)
    {
        ...
        for(int i=0; i<1 ; i++)
        {
            ...
            /// si tiene bendicion hormiga elige un numero
            ...
            /// lanza 5 dados a eleccion
            lanzarCincoDadosSeisCarasLab(vJugadores,primerJugador);
        ...
        if(FinFF==false)
        {
            ...
            for(int i=0; i< 1 ; i++)
            {
                ...
                /// pide valores de dados y los lanza
                lanzarCincoDadosSeisCarasLab(vJugadores,segundoJugador);
